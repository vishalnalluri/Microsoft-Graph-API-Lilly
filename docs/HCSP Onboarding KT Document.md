...
Ajay Sends Survey through email

.

Step 2:

Download Survey and make sure Provider Names
...
in the Lambda function code and deploy.

Ex: List-43

S3:

onboarding-list-creation-data
