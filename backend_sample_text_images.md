...
(cid:127) Extract all text from each page.
(cid:127) Identify embedded images and charts.
(cid:127) Read tabular content without losing row and column structure.
(cid:127) Preserve page order and section headings.
(cid:127) Return clean JSON output from the backend service.
3. Sample Table
Record ID Name Type Status Amount
1001 Alpha Health Customer Active $1,250
1002 Blue River Partner Pending $860
