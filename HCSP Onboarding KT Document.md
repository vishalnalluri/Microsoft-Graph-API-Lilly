...
![Page 1](<images/HCSP Onboarding KT Document/page_1.png>)

Onboarding Process 
People Involved:  
Syra – Sely-Ann (Project Manager), Ekaterina (Reporting Team), Ajay (Support Team), 
Anusha (Learning Paths Content Creator) 
Yes LMS – Felipe/Doug 
State – Jessica, Kathy, Richard 
Steps of Onboarding Process: 
Step1: Ajay Sends Survey through email. 
Step 2: Download Survey and make sure Provider Names have any special characters like 
the apostrophe. If found, remove it. 
Step 3: Open  
Lambda Function: Onboarding-List-Creation - > Change List number in the Lambda 
function code and deploy. Ex: List-43  
...
![Page 2](<images/HCSP Onboarding KT Document/page_2.png>)
